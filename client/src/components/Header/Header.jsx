...
import { logoutOrganizationStart } from '../../redux/actions/organizationsAC';
...
export default function Header() {
  ...
  const OrgLogoutHandler = () => {
    dispatch(logoutOrganizationStart());
  ...
  return (
    <div className="header">
      <nav className="navbar navbar-dark bg-my-primary">
        ...
        <div>
          { !currentUser?.email && !currentOrganization?.email && (
          <>
