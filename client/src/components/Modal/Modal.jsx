        ...
        {isAdded
          ? (
            <div className="d-flex flex-column align-items-center">
              ...
              <button type="button" className="btn btn-primary w-25" onClick={() => setIsModalOpened((state) => !state)}>OK</button>
            </div>
          )
          : (
            <form id="newCourseForm" style={{ width: '85%' }}>
              ...
              <button type="button" className="btn btn-primary" onClick={addCourseHandler}>Добавить</button>
